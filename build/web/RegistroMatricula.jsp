            ...
            <table class="table table-bordered"  id="tablaDatos">
                ...
                <tbody id="tbodys">
                    ...
                    <%
                        ...
                        List<Matricula> list = dao.listarMatricula();
                    ...
                    <tr>
                        <td class="text-center"><%=list.get(i).getIdMatricula()%></td>
                        <td class="text-center"><%=list.get(i).getIdCurso()%></td>
                        <td class="text-center"><%=list.get(i).getIdAlumno()%></td>
                ...
                <div class="modal-dialog" role="document" style="z-index: 9999; width: 450px">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="MatriServlet" method="post">
                                <label>IdCurso</label><br>
                                <input class="form-control" type="text" name="idCurso"><br>
                                <label>IdAlumno</label><br>
                                <input class="form-control" type="text" name="idAlumno"><br>
                ...
                <div class="modal-dialog" role="document" style="z-index: 9999; width: 450px">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="EditarMatricula" method="post">
                                <label>Id</label><br>
